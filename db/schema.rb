...
ActiveRecord::Schema.define(version: 20150604234910) do
  ...
  create_table "customers_vendors", id: false, force: true do |t|
    t.integer "customer_id"
    t.integer "vendor_id"
  end

  add_index "customers_vendors", ["customer_id"], name: "index_customers_vendors_on_customer_id", using: :btree
  add_index "customers_vendors", ["vendor_id"], name: "index_customers_vendors_on_vendor_id", using: :btree
